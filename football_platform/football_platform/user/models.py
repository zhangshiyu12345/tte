...
class NewUser(AbstractUser):
    ...
    pass_football = models.FloatField(verbose_name='传球',default=10000)
    hotshot = models.FloatField(verbose_name='射门',default=200)
    speed_num = models.FloatField(verbose_name='加速次数',default=5000)
    join_time = models.FloatField(verbose_name='上场时长(分钟)',default=2000)
    sprint_distance = models.FloatField(verbose_name='冲刺距离(公里)',default=50)
    sprint_num = models.FloatField(verbose_name='冲刺次数',default=1000)
    heart_avg = models.FloatField(verbose_name='平均心率',default=70)
    run_distance = models.FloatField(verbose_name='跑动距离(公里)',default=300)
